<div class="form-group">
    ...
    @error('project_id')
        <p class="text-danger">{{ __('GestionProjets/task/' . $message) }}</p>
    @enderror
</div>
...
<div class="form-group">
    ...
    <input name="nom" type="text" class="form-control" id="exampleInputEmail1" placeholder="Entrer le nom"
        value="{{ isset($task) ? $task->nom : null }}">
    @error('nom')
        <p class="text-danger">{{ __('GestionProjets/task/' . $message) }}</p>
    @enderror
</div>
...
<div class="form-group">
    ...
    <textarea name="description" class="form-control" rows="7" id="inputDescription"
        placeholder="Entrez la description">{{ isset($task) ? $task->description : null }}</textarea>
        @error('description')
            <p class="text-danger">{{ __('GestionProjets/task/' . $message) }}</p>
        @enderror
</div>
...
<div class="form-group">
    ...
    <input name="date_debut" type="date" class="form-control" id="exampleInputPassword1" placeholder="Mot de passe"
        value="{{ isset($task) ? $task->date_debut : null }}">
        @error('date_debut')
            <p class="text-danger">{{ __('GestionProjets/task/' . $message) }}</p>
        @enderror
</div>
...
<div class="form-group">
    ...
    <input name="date_de_fin" type="date" class="form-control" id="exampleInputPassword1" placeholder="Mot de passe"
        value="{{ isset($task) ? $task->date_de_fin : null }}">
    @error('date_de_fin')
        <p class="text-danger">{{ __('GestionProjets/task/' . $message) }}</p>
    @enderror
</div>
